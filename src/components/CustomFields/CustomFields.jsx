import { Select, Input, ThemeProvider, Typography, Textarea, Option } from "@material-tailwind/react";
...
export function CustomDatepicker({ onChange, placeholder, name, value, minDate, ...restProps }) {

  return (
        <Datepicker
          placeholder={placeholder}
          inputClassName="border border-gray-400 focus:border-purple-500 focus:outline-none rounded-md w-full pl-3 h-full"
          asSingle={true}
          useRange={false}
          onChange={({ startDate }) => onChange({ target: { name, value: startDate } })}
